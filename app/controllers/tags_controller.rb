class TagsController < ApplicationController
  ...
  def index
    ...
    render partial: "tags_results", locals: { tags: @tags } if turbo_frame_request?
  end
  ...
  def update
    respond_to do |format|
      if @tag.update(tag_params)
        format.html { redirect_to tags_path, notice: "Tag was successfully updated.", status: :see_other }
